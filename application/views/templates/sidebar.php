<body id="page-top">
	...
	<div id="wrapper">
		...
		<!-- Sidebar -->
		<ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #323653;">
			...
			<a class="sidebar-brand d-flex align-items-center justify-content-center my-2"
				...
				<div class="mx-3">
					<div><img src="./assets/img/logo.png" alt="" style="height: 50px;"></div></div>
			</a>
			<!-- Divider -->
